...
//               <td>Rs {transaction.payments?.[0]?.amount || "N/A"}</td>

//               <td>{transaction.payment_status}</td>
//               <td>{transaction.payments?.[0]?.payment_mode || "N/A"}</td>
//               {/* <td>
//                 Rs {transaction.payments.reduce((sum, p) => sum + parseFloat(p.amount), 0)}
//               </td> */}
...
//         <tbody>
//           {transactions
//             .filter((transaction) => transaction.transaction_type === "sale") // Filtering only "sale" transactions
...
//         `http://127.0.0.1:8000/api/v1/financials/payments/${selectedTransaction.id}/`,
...
//         <tbody>
//           {transactions
//             .filter((transaction) => transaction.transaction_type === "purchase") // Filtering only "purchase" transactions
//             .map((transaction, index) => (
//               <tr key={transaction.id}>
//                 <td>{index + 1}</td>
//                 <td>{transaction.transaction_id}</td>
...
//                     disabled={transaction.remaining_amount === "0.00"}
//                   >
//                     Pay Now
//                   </Button>
//                 </td>
