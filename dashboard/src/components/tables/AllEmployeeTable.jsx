...
//                 <td>Sales</td>
//                 <td>9876546789</td>
//                 <td>ingo@gmail.com</td>
//                 <td>
//                     <span className="address-txt">Kutt9iady,Kerala</span>
//                 </td>
//             </tr>   
//             ))}
  ...
  useEffect(() => {
    const fetchStaffUsers = async () => {
      try {
        ...
        setDataList(result.staff_users.map(user => ({
          ...user,
          showDropdown: false,
          image: "default-avatar.png", // Replace with real image logic if available
          phone: "N/A",
          section: "N/A",
          present_address: "N/A"
        })));
        ...
        <tbody>
          {currentData.map((data, index) => (
            <tr key={data.id}>
              ...
              <td>{data.id}</td>
              <td>
                <img src={data.image} alt="User" className="avatar" />
              </td>
              <td>{data.username} </td>
              <td>{data.phone}</td>
              <td>{data.email}</td>
